Gem::Specification.new do |s|
  ...
  s.description = "Manage different hosts on the fly. Easily get the value you want from the JSON strings. Use hashes on your requests."
  ...
  s.license       = 'MIT'
  s.add_runtime_dependency 'nice_hash', '~> 1.3', '>= 1.3.0'
end
